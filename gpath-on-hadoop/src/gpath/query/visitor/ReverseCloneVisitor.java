...
public class ReverseCloneVisitor implements Visitor<Expression, Object> {
	...
	public Expression visitConcat(Concat concat, Object... args) {
		...
		cat.setFirst(concat.getSecond().accept(this));
		cat.setSecond(concat.getFirst().accept(this));
		return cat;
	}
