...
import gpath.query.stm.StateMachine.Condition;
import gpath.query.stm.StateMachine.State;
...
public class SimpleStateMachine {
	...
	List<StateMachine.Transition> buildTransitions(int startState){
		...
		if(success.get(startState)){
			StateMachine.Transition transition = new Transition(TransitionType.OutSuccess, NoRestriction.I, 0);
